  ...
  return (
    <section className="py-20 md:py-28">
      <div className="container-x w-full">
        <div className="mb-10 grid gap-8 md:grid-cols-12 md:gap-10">
          ...
          <div className="md:col-span-9">
            ...
            >
              Have something
              <br />
              <em className="font-serif italic text-paper-500 dark:text-paper-400">thoughtful</em> to
              build?
            </motion.h2>
            ...
            <motion.p
              ...
              className="mt-6 max-w-xl text-base text-paper-600 dark:text-paper-400 md:text-lg"
            >
              Open to full-time roles, research collaborations, and a small number of freelance
              engagements. Best reached by email — I reply within a day or two.
            </motion.p>
            ...
            <motion.a
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-full border border-paper-900 bg-paper-900 px-6 py-3 text-sm font-medium text-paper-50 transition-colors hover:bg-paper-800 dark:border-paper-100 dark:bg-paper-100 dark:text-paper-950 dark:hover:bg-paper-200"
            >
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {channels.map(c => (
              ...
              >
                <div className="section-label mb-1 transition-colors group-hover:text-paper-900 dark:group-hover:text-paper-100">
                  {c.label}
                </div>
                <div className="inline-flex items-center gap-1 text-sm text-paper-700 group-hover:text-paper-900 dark:text-paper-300 dark:group-hover:text-paper-100">
                  ...
                  {c.href.startsWith('http') && <ArrowUpRight size={11} />}
                </div>
              </a>
            ))}
          </div>
